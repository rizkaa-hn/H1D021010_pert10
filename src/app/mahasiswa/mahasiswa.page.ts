...
export class MahasiswaPage implements OnInit {
  ...
  getMahasiswa(){
    this._apiService.tampil('proses_view.php').subscribe({
      next: (res: any) => {
  ...
  tambahMahasiswa(){
    if(this.nama!=''&& this.jurusan !=''){
      ...
      this._apiService.tambah(data,'/proses_add.php').subscribe({
        next: (hasil: any) => {
          this.reset_model();
  ...
  hapusMahasiswa(id: any){
    this._apiService.hapus(id, '/proses_delete.php?id=').subscribe({
      next: (res: any)=> {
        console.log('sukses',res);
        this.getMahasiswa();
  ...
  ambilMahasiswa(id: any){
    this._apiService.lihat(id, '/proses_viewid.php?id=').subscribe({
      next: (hasil: any)=> {
  ...
  editMahasiswa(){
    ...
    this._apiService.edit(data,'/proses_edit.php').subscribe({
      next: (hasil: any)=> {
        console.log(hasil);
        this.reset_model();
        this.getMahasiswa();
